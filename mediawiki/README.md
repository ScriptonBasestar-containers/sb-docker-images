...
|--------|-------------|---------------|------|
| mediawiki | 8080 | 80 | MediaWiki 웹 UI |
| mariadb | (내부) | 3306 | MariaDB (외부 서비스) |
| redis | (내부) | 6379 | Redis (외부 서비스) |

> 참고: 기본 설정은 8080번 포트를 사용합니다. 포트 충돌을 피하려면 compose.yml을 수정하세요.
> 권장 포트: 8300 (PORT_GUIDE.md 참조)
