...
이 저장소에는 여러 Docker 기반 프로젝트가 포함되어 있으며, 동시에 여러 프로젝트를 실행할 때 포트 충돌이 발생할 수 있습니다. 이 문서는 **포트 관리 방법론**과 **충돌 방지 전략**을 안내합니다.

> **참고**: 현재 포트 할당 상태는 [../PORT_STATUS.md](../PORT_STATUS.md)를 참조하세요.
...
| flarum | 8510 | Web | - |
| forem | 8520 | Web | 3333 (Chrome) |

### 개발 도구 (8600-8699, 일부 예외)
...
|---------|----------|--------|-----------|
| squid | 3128 | Proxy | - |
| kratos | 4433 | Public API | 4434 (Admin), 4455 (UI) |
| mailslurper | 8810 | Web | 2500 (SMTP) |
| mariadb | - | DB | 3306 |
| postgres-exts | - | DB | 5432 |

> **참고**: Ory Kratos는 표준 포트 4433/4434를 사용합니다.
