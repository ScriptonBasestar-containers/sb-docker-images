...
> ⚠️ **주의**: XE3는 업데이트가 중단된 상태입니다. 프로덕션 사용을 권장하지 않으며, WordPress, Drupal, Joomla 등의 대안을 고려하세요.

## 개요

XpressEngine 3(XE3)는 네이버에서 개발한 PHP 기반의 오픈소스 CMS 및 게시판 플랫폼입니다:
- 🏗️ Laravel 프레임워크 기반
- 🎨 다양한 플러그인과 테마
- 🔌 확장 가능한 아키텍처
- 📱 반응형 디자인 지원
...
커뮤니티 사이트, 기업 홈페이지, 블로그 등 다양한 용도로 활용할 수 있습니다.
