...
> 💡 **Quick Start**: For production deployment with PostgreSQL database included, use the [standalone setup](standalone/) - it includes complete configuration and documentation!
...
To change the port, edit `docker-compose.yml` or create a `.env` file:
```bash
WIKI_PORT=8320  # Change to your preferred port
```
