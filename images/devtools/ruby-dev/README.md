...
Ruby on Rails 애플리케이션 개발을 위한 완전한 Docker 환경입니다:

- 💎 **Ruby**: 커스터마이징 가능한 Ruby 버전
- 🚂 **Rails**: Ruby on Rails 프레임워크 지원
- 📦 **Bundler**: Gem 의존성 관리
- 🌐 **Node.js 8**: 프론트엔드 빌드 도구
- 📦 **Webpack & Yarn**: 모던 JavaScript 빌드 시스템
- ⚡ **빠른 다운로드**: 카카오 미러 사용
- 👤 **커스텀 사용자**: 비 root 사용자로 안전한 실행
- 🔐 **Sudo 권한**: 필요 시 관리자 권한 사용 가능
- 📂 **작업 디렉토리**: /work에서 개발
- 🔄 **볼륨 마운트**: 호스트에서 편집, 컨테이너에서 실행
