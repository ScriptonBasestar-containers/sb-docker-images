...
|--------|-------------|---------------|------|
| wiki | 80 | 3000 | Wiki.js 웹 UI |
| db | (내부) | 5432 | PostgreSQL |

> 참고: 기본 설정은 80번 포트를 사용합니다. 포트 충돌을 피하려면 docker-compose.yml을 수정하세요.
> 권장 포트: 8320 (PORT_GUIDE.md 참조)
